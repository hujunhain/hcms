...
<html>
    <head>
        ...
        <title><g:message code="cooperationType.edit" default="Edit CooperationType" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="cooperationType.edit" default="Edit CooperationType" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${cooperationTypeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
