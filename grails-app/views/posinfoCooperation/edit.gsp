...
<html>
    <head>
        ...
        <title><g:message code="posinfoCooperation.edit" default="Edit PosinfoCooperation" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="posinfoCooperation.edit" default="Edit PosinfoCooperation" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${posinfoCooperationInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="baseSales"><g:message code="posinfoCooperation.baseSales" default="Base Sales" />:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: posinfoCooperationInstance, field: 'baseSales', 'errors')}">
