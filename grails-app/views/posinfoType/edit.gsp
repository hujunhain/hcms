...
<html>
    <head>
        ...
        <title><g:message code="posinfoType.edit" default="Edit PosinfoType" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="posinfoType.edit" default="Edit PosinfoType" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${posinfoTypeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
