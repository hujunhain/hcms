...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'area', 'error')} required">
	<label for="area">
		<g:message code="user.area.label" default="Area" />
		<span class="required-indicator">*</span>
	</label>
...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'mobleNo', 'error')} ">
	<label for="mobleNo">
		<g:message code="user.mobleNo.label" default="Moble No" />
