...
<html>
    <head>
        ...
        <title><g:message code="alcoholType.edit" default="Edit AlcoholType" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="alcoholType.edit" default="Edit AlcoholType" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${alcoholTypeInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
