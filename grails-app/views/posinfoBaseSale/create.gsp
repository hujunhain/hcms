...
<html>
    <head>
        ...
        <title><g:message code="posinfoBaseSale.create" default="Create PosinfoBaseSale" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="posinfoBaseSale.create" default="Create PosinfoBaseSale" /></h1>
