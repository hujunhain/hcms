...
<html>
    <head>
        ...
        <title><g:message code="posinfoState.edit" default="Edit PosinfoState" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="posinfoState.edit" default="Edit PosinfoState" /></h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${posinfoStateInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
